    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'Pool Ramos Ramos'
			nuevoUsuario1.email = 'pool.ramos@gmail.com'
			...
			nuevoUsuario2.nombre = 'Next U Estudiante'
			nuevoUsuario2.email = 'nextu@estudiante.com'
